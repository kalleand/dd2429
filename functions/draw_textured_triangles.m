...
%               between 1 and N.
%
% X             Nx1 vector containing the X-coordinates for each point.
% Y             Nx1 vector containing the Y-coordinates for each point.
% Z             Nx1 vector containing the Z-coordinates for each point.
%
% U             Nx1 vector containing the U-texture-coordinates for each point.
% V             Nx1 vector containing the V-texture-coordinates for each point.
%
