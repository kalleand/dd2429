...
norm_homographies{1} = det_homographies(data_norm(1:3, 1:am_points/2), data_norm(7:9, 1:am_points/2));
norm_homographies{2} = det_homographies(data_norm(4:6, (am_points/2)+1:am_points), data_norm(7:9, (am_points/2)+1:am_points));
